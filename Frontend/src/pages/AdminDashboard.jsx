      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400">Manage auctions, items, and monitor platform activity</p>
          </div>
                    ...
                    <tbody className="divide-y divide-slate-700/50">
                      {recentAuctions.map((auction) => (
                        <tr key={auction.id} className="hover:bg-slate-800/30 transition-colors">
                          ...
                          <td className="px-6 py-4 text-slate-300">{auction.items}</td>
                          <td className="px-6 py-4 text-slate-300">{auction.bidders}</td>
                          <td className="px-6 py-4">
